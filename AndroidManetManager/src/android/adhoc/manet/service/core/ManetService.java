...
public class ManetService extends Service {
	...
	public final static String ACTION_SERVICE_STARTED		= "android.adhoc.manet.service.intent.action.SERVICE_STARTED";
	public final static String ACTION_SERVICE_STOPPED		= "android.adhoc.manet.service.intent.action.SERVICE_STOPPED";
	public final static String ACTION_ADHOC_STATE_UPDATED	= "android.adhoc.manet.service.intent.action.ADHOC_STATE_UPDATED";
	public final static String ACTION_CONFIG_UPDATED		= "android.adhoc.manet.service.intent.action.CONFIG_UPDATED";
	public final static String ACTION_LOG_UPDATED			= "android.adhoc.manet.service.intent.action.LOG_UPDATED";
	...
	public void showNotification(String content) {
    	...
    	if (notification == null || notification.icon != icon) {    		
	    	...
	    	launchIntent.setComponent(new ComponentName("android.adhoc.manet", "android.adhoc.manet.manager.MainActivity"));
