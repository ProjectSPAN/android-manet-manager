 ...
 */
package android.adhoc.manet.service.system;
	...
	public static BluetoothService getInstance() {
	    if (bluetoothService == null) {
	        ...
	        if (sdkVersion < Build.VERSION_CODES.ECLAIR) {
	            className = "android.adhoc.manet.service.system.BluetoothService_cupcake";
	        } else {
	            className = "android.adhoc.manet.service.system.BluetoothService_eclair";
	        }
